            ...
            <div>
                ...
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <p className="py-6">Course Not Found</p>
                        <Link className="btn btn-primary" href={'/learn/courses'}>Find Some</Link>
                    </div>
                </div>
                </div>
            </div>
    ...
    return (
        <div>
         <div className="hero min-h-screen bg-base-200 shadow-xl">
           <div className="hero-content text-center">
             <div className="max-w-md">
               <h1 className="text-5xl font-bold">{course.subject} </h1>
               <p className="py-6">{course.skills.join(", ")}</p>

                <div className="stats shadow">
                  <div className="stat">
                    <div className="stat">
                        <div className="stat-title text-xl">Estimated time</div>
                        <div className="stat-value text-2xl">{String(course.estimated_time)}</div>
                    </div>
                  </div>
                </div>
                <div className="divider divider-neutral"></div>
                <ul className="steps w--screen">
                    {/* make a loop that will loop a random amount of times */}
                    <li className="step">
                    ...
                    <li className="step">
                     ...
                     <li className="step">
                        <div className="step-content">
                            <div className="step-title">Expert!</div>
                            <p></p>
                        </div>
                    </li>
                </ul>
